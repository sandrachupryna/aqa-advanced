...
console.log(
  isObjectsEqual({ name: 'John', age: 30 }, { age: 30, name: 'john' })
); // true
console.log(
  isObjectsEqual({ name: 'Alice', age: 25 }, { name: 'alice', age: 26 })
); // false
console.log(
  isObjectsEqual({ city: 'New York' }, { city: 'new york', country: 'USA' })
); // false
console.log(
  isObjectsEqual({ name: 'Alice', age: 25 }, { name: 'alice', age: '26' })
); // false
