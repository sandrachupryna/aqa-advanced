...
const promiseCollectionSettled = Promise.allSettled([
  promiseTodoThenCatch,
  promiseUserThenCatch,
  promiseTodoAsyncAwait,
  promiseUserAsyncAwait,
]);
promiseCollectionSettled.then((x) => console.log('All Settled:', x));

const promiseCollectionAll = Promise.all([
  promiseTodoThenCatch,
  promiseUserThenCatch,
  promiseTodoAsyncAwait,
  promiseUserAsyncAwait,
...
const promiseCollectionRace = Promise.race([
  promiseTodoThenCatch,
  promiseUserThenCatch,
  promiseTodoAsyncAwait,
  promiseUserAsyncAwait,
