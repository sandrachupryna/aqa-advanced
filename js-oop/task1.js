...
const ebook2 = new EBook("Тореодори з Васюківки", "Всеволод Нестайко", 1972, "EPUB");
...
/// Перевірка геттерів
console.log(`Книга 1: ${book1.title}, Автор: ${book1.author}, Рік: ${book1.year}`);
console.log(`Електронна книга 2: ${ebook2.title}, Автор: ${ebook2.author}, Рік: ${ebook2.year}, Формат: ${ebook2.fileFormat}`);
// Виклик для статичної змінної та метода через клас
console.log(`Доступні формати електронних книг: ${Array.from(EBook.formatTypes).join(', ')}`);
...
console.log(`Найстаріша книга: "${oldestBook.title}", автор ${oldestBook.author}, рік видавництва ${oldestBook.year}.`);
